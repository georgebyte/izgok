...
function checkUnsolved(){
        ...
        $quizHistory = Quiz::whereRaw('(id_attacker = '.$myID.' AND quiz_opened_attacker > '.$timenow.') OR (id_defender = '.$myID.' AND quiz_opened_defender is null)') -> orderBy('created_at','desc') ->get(array('id', 'created_at','id_attacked_territory'));
